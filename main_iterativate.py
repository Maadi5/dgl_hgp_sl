...
save_weights = '/content/drive/MyDrive/dgl_hgp_sl/weights_sharma_logs'

input_path = '/content/drive/MyDrive/dgl_hgp_sl/dataset/'
...
def main(args):
    ...
    for p in range(len(train_all)):
        ...
        test_set =  OdourDataset(datasetpath= test_all[p])
        ...
        for e in range(args.epochs):
            ...
            #     print(test_conf)
                torch.save(model, str(Path(save_weights)/('odour_weights_epo'+str(e)+ '_itr' + str(p) +'.pt')))
